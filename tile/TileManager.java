...
public class TileManager {
    ...
    public TileManager(GamePanel gp){
        ...
        getTileImage();
        loadMap("maps/level1.txt", 0);
        loadMap("maps/level2.txt", 1);
        loadMap("maps/level3.txt", 2);
    }
    ...
    public void getTileImage(){
        ...
        tile[10] = new Tile();
        tile[10].image = ImageManager.loadBufferedImage("sprites/tiles/path-inner-corner-1.png");

        tile[11] = new Tile();
        tile[11].image = ImageManager.loadBufferedImage("sprites/tiles/path-inner-corner-2.png");

        tile[12] = new Tile();
        tile[12].image = ImageManager.loadBufferedImage("sprites/tiles/tile004.png");

        tile[13] = new Tile();
        tile[13].image = ImageManager.loadBufferedImage("sprites/tiles/tile021.png");

        tile[14] = new Tile();
        tile[14].image = ImageManager.loadBufferedImage("sprites/tiles/tile007.png");

        tile[15] = new Tile();
        tile[15].image = ImageManager.loadBufferedImage("sprites/tiles/tile005.png");
    ...
    public void draw(Graphics2D g2){
        ...
        while(col < panel.maxWorldCol && row < panel.maxWorldRow){
            ...
            int tileNum = mapTileNum[panel.currentMap][col][row];
