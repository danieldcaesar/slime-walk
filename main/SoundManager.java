...
public class SoundManager {				// a Singleton class
	...
	private SoundManager () {
		...
		clip = loadClip("sounds/Randomize2.wav");
		clips.put("pause", clip);
		
		clip = loadClip("sounds/Randomize4.wav");
		clips.put("title", clip);

		clip = loadClip("sounds/Explosion.wav");
		clips.put("slimeDeath", clip);

		clip = loadClip("sounds/Jump.wav");
		clips.put("levelUp", clip);

		clip = loadClip("sounds/Laser2.wav");
		clips.put("throw", clip);

		clip = loadClip("sounds/Randomize3.wav");
		clips.put("hurt", clip);
